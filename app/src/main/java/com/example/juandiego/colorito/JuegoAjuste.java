 ...
 * {@link JuegoAjuste.OnFragmentInteractionListener} interface
 * to handle interaction events.
 * Use the {@link JuegoAjuste#newInstance} factory method to
 * create an instance of this fragment.
 */
public class JuegoAjuste extends Fragment {
    ...
    TextView correcta, incorrecta, palabraColor, desplegadas, faltantes, txtporcentaje, txtTime, txtTotal;
    ...
    CountDownTimer contador, contadorFinal;
    int tiempoPalabra = 4000;//3 Segundos
    int tiempoTotal = 0, tipo;
     ...
     * @return A new instance of fragment JuegoAjuste.
     */
    // TODO: Rename and change types and number of parameters
    public static JuegoAjuste newInstance(String param1, String param2) {
        JuegoAjuste fragment = new JuegoAjuste();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        view = inflater.inflate(R.layout.fragment_juego_ajuste, container, false);
        ...
        txtTotal = view.findViewById(R.id.tiempoTotal);
        ...
        SharedPreferences preferences = this.getActivity().getSharedPreferences("Credenciales", getContext().MODE_PRIVATE);

        tiempoPalabra = preferences.getInt("tiempoPalabra", 0);
        tiempoPalabra = tiempoPalabra * 1000;
        tipo = miBundle.getInt("tipo");
        switch (tipo) {
            case 1:
                tiempoTotal = preferences.getInt("tiempoTotal", 0);
                break;
            case 2:
                falta = preferences.getInt("intentos", 3);
                break;
        }
        ...
        if (tipo==1){
            ...
            contadorFinal = new CountDownTimer(tiempoTotal, 1000) {
                @Override
                public void onTick(long millisUntilFinished) {
                    int segundosRestantes = (int) millisUntilFinished / 1000;
                    txtTotal.setText("Tiempo total: " + Integer.toString(segundosRestantes));
                }
    ...
    public void comprobar(int numeroBtn) {
        ...
        contador.cancel();
        desplegadas.setText("Desplegadas: " + palabras);
        faltantes.setText("Faltantes: " + falta);
